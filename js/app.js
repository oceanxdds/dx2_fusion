...
const ddd_stable = [
    {
        ...
        devils:[
            {   name:'メタトロン',       name_tw:'梅塔特隆', name_en:'Metatron',   rarity:5,   grade:99,  icon:'daitensi_metatoron.png',  skills:['天罰','無限のチャクラ','シナイの神火'], skill4:['不屈の闘志','マハンマダイン','討滅の咆哮','二分の魔脈','電撃反射'], skill5:['','吸魔','マハポイズマ','マハジオダイン','マハラギダイン'], elements:['','rs','rs','rs','rs','nu',''], type:'attack'     },
            {   name:'ミカエル',        name_tw:'米迦勒', name_en:'Michael',      rarity:5,    grade:90, icon:'daitensi_mikaeru.png', skills:["勝利の息吹","魂の審判","メギドラオン"], skill4:["食いしばり","裁きの雷火","メディアラハン","奈落のマスク","呪殺反射"], skill5:['','ティタノマキア','火炎耐性','ジオダイン','刹那五月雨撃ち'], elements:['','','nu','nu','','rp','wk'], type:'attack'     },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'イシュタル',        name_tw:'伊絲塔', name_en:'Ishtar',       rarity:5,                grade:82, icon:'megami_isyutaru.png', skills:["マハンマオン","ディアラハン","ジャッジメント"], skill4:["サマリカーム","裁きの雷火","コンセントレイト","テトラカシフト","衝撃無効"], skill5:['',"ゴッドハンド","毒床渡り","デクンダ","アギラオ"],elements:['','','','nu','wk','nu','wk'], type:'heal'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'ヴィシュヌ',      name_tw:'毘濕奴', name_en:'Vishnu',         rarity:5,                grade:97, icon:'majin_visyunu.png', skills:["ブフダイン","天罰","アヴァターラ"], skill4:["ムドダイン","メギドラオン","勇奮の鼓舞","魔封無効","呪殺反射"], skill5:['',"モータルジハード","魔封耐性","ウィンドブレス","ハマオン"],elements:['','wk','rp','','','nu','nu'], type:'attack'            },
            {                name:'アマテラス',      name_tw:'天照', name_en:'Amaterasu',         rarity:5,                grade:82, icon:'majin_amaterasu.png', skills:["マハラギオン","タルンダ","天孫降臨"], skill4:["スクカオート","トリスアギオン","メディアラハン","三段の賢魔","電撃無効"], skill5:['',"ジュオン","魅了無効","ラクカジャ","スクンダ"],elements:['','rp','','wk','','rs',''], type:'support'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'バロン',         name_tw:'巴隆', name_en:'Barong',      rarity:5,                grade:84, icon:'sinjyuu_baron.png', skills:["マハジオンガ","ショックウェーブ","バロンダンス"], skill4:["食いしばり","真理の雷","リカームドラ","電撃ハイブースタ","呪殺無効"], skill5:['',"ブフダイン","マハシバブー","二段の恵体","マカジャマ"],elements:['rs','','','nu','wk','nu','wk'],type:'support'           },
    ...
    },
    {
        ...
        devils:[
            {   name:'シヴァ',           name_tw:'濕婆', name_en:'Shiva',     rarity:5,  grade:93, icon:'hakaisin_siva.png' , skills:["虐殺者","空間殺法","プララヤ"], skill4:["魅了無効","ゴッドハンド","リベリオン","寸分の見切り","氷結吸収"], skill5:['',"デゾレトオン","アイスブレス","ブフーラ","マハポイズマ"],elements:['rs','rp','wk','rp','','',''],type:'attack'           },
            ...
            {   name:'スサノオ',         name_tw:'素盞嗚尊', name_en:'Susano-o',  rarity:5,  grade:82, icon:'hakaisin_susanoo.png', skills:["暗殺者","モータルジハード","天叢雲剣"], skill4:["三段の剛力","血管断ち","チャージ","無慈悲な一撃","電撃吸収"], skill5:['',"ディアラハン","地獄の業火","フォッグブレス","ハマダイン"],elements:['rs','wk','','','rp','',''],type:'attack'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'アナンタ',      name_tw:'阿南塔', name_en:'Ananta',         rarity:5,                grade:83, icon:'ryuuou_ananta.png' , skills:["ディアラハン","スクカオート","ラクカオート"], skill4:["天罰","マハブフダイン","マハポイズマオン","タルカオート","氷結吸収"], skill5:['',"ギガントマキア","マハザンダイン","モータルジハード","鬼神楽"],elements:['','','nu','nu','wk','nu',''], type:'support'           },
    ...
    },
    {
        ...
        devils:[
            {                name:'サマエル',       name_tw:'薩麥爾', name_en:'Samael',        rarity:5,                grade:84, icon:'datensi_samaeru.png', skills:["勝利のチャクラ","メシアライザー","神の悪意"], skill4:["デスカウンター","煉獄","テトラカーン","無限のチャクラ","火炎無効"], skill5:['',"ファイアブレス","アギラオ","丸かじり","回復ブースタ"],elements:['','','','wk','','rp','rp'], type:'support'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'リリス',        name_tw:'莉莉絲', name_en:'Lilith',       rarity:5,                grade:80, icon:'yoma_ririsu.png', skills:["マハジオダイン","エナジードレイン","肉体の解放"], skill4:["狂い咲き","精神漏出","サマリカーム","三段の強運","破魔無効"], skill5:['',"毒床渡り","タルンダ","煉獄","暗殺者"],elements:['','rs','rs','rp','wk','wk','nu'], type:'support'            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'マーラ',         name_tw:'魔羅', name_en:'Mara',      rarity:5,                grade:90, icon:'maou_mara.png', skills:["緊縛無効","ティタノマキア","地獄突き"], skill4:["メガトンレイド","ソウルドレイン","チャージ","物理貫通","氷結無効"], skill5:['',"真理の雷","デゾレトオン","マハマカジャオン","地獄の業火"],elements:['','','wk','rp','','rs','rs'], type:'attack'            },
            {                name:'スルト',         name_tw:'史爾特爾', name_en:'Surt',     rarity:5,                grade:83, icon:'maou_suruto.png', skills:["怪力乱神","テトラカシフト","ラグナロク"], skill4:["威圧の構え","マハラギダイン","ディスタブ","火炎貫通","氷結無効"], skill5:['',"毒追撃","衝撃ブースタ","ラクンダ","丸かじり"],elements:['','rp','wk','','','',''], type:'attack'            },
    ...
    },
    {
        ...
        devils:[
            ...
            { name:'トランペッター', name_tw:'吹號者', name_en:'Trumpeter', rarity:5, grade:94, icon:'majin_toranpeta.png', skills:['コンセントレイト','ソウルドレイン','アポカリプス'], skill4:['マハマカジャオン','ジャッジメント','悪魔の産声','ラクカオート','物理耐性'], skill5:['','タルカジャ','マハブフーラ','空間殺法','火炎耐性'], elements:['','','','','','nu','nu'], type:'attack'},
