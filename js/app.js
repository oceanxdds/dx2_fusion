...
const ddd_stable = [
    ...
    },
    {
        ...
        formulas:[],
        devils:[
            { name:'アリラト', name_tw:'阿利拉特', name_en:'',rarity:5, grade:85, icon:'irei_arirato.png', skills:['メギドラ','奈落のマスク','貫反の霊圧'], skill4:['ディアラハン','ソウルドレイン','メディラマ','二分の魔脈','物理無効'], skill5:['','','','',''], elements:['耐','','','','','耐','耐'], type:'回復'}
        ]
    }
];
