...
const ddd_stable = [
    ...
    },/*
    {
        ...
        devils:[
            {  name:'コウリュウ',  name_tw:'黃龍', name_en:'',  rarity:5,  grade:88, icon:'ryuusin_kouryu.png' , skills:["二段の猛速","メギドラオン","五行思想"], skill4:["勝利の息吹","エナジードレイン","ラスタキャンディ","スピードスター","呪殺無効"], skill5:["","","","",""],elements:["","耐","耐","耐","耐","無",""],type:"攻擊"   },
            {  name:'ケツアルカトル',  name_tw:'羽蛇神', name_en:'',  rarity:5,  grade:80, icon:'ryuusin_kezuarukatoru.png' , skills:["マハラギダイン","マハザンダイン","セアカトルの再臨"], skill4:["毒無効","マハンマダイン","コンセントレイト","タルンダオート","物理反射"], skill5:["","","","",""],elements:["耐","耐","","","耐","耐","弱"],type:"攻擊"   },
            {  name:'グクマッツ',  name_tw:'', name_en:'',  rarity:4,  grade:69, icon:'ryuusin_gukumatu.png' , skills:["ヒートウェイブ","アイスプレス","タルンダオート"], skill4:["野生の勘","ウィンドブレス","フォッグブレス","テトラカシフト","火炎無効"], skill5:["","","","",""],elements:["","弱","耐","","耐","",""],type:"攻擊"   },
            {  name:'セイリュウ',  name_tw:'青龍', name_en:'',  rarity:4,  grade:63, icon:'ryuusin_seiryuu.png' , skills:["衝撃ブースタ","ザンダイン","龍の反応"], skill4:["二段の猛速","怪力乱神","コンセントレイト","勝利のチャクラ","衝撃反射"], skill5:["","","","",""],elements:["","","耐","弱","無","",""],type:"攻擊"   },
            {  name:'イルルヤンカシュ',  name_tw:'', name_en:'',  rarity:3,  grade:47, icon:'ryuusin_iruruyankasyu.png' , skills:["アイスブレス","ザンマ","龍の反応"], skill4:["ブフダイン","マハザンマ","溶解ブレス","二段の賢魔","衝撃無効"], skill5:["","","","",""],elements:["","","耐","","耐","",""],type:"攻擊"   },
            {  name:'マカラ',  name_tw:'', name_en:'',  rarity:3,  grade:41, icon:'ryuusin_makara.png' , skills:["マカラコワース","マハブフ","タルンダ"], skill4:["虚弱無効","メギド","マカラカーン","三分の活泉","火炎耐性"], skill5:["","","","",""],elements:["","弱","耐","","","",""],type:"支援"   },
            {  name:'パトリムパス',  name_tw:'', name_en:'',  rarity:2,  grade:35, icon:'ryuusin_patorimupasu.png' , skills:["リカーム","ディアラマ","テトラジャ"], skill4:["自然治癒","ウィンドブレス","アムリタ","食いしばり","火炎耐性"], skill5:["","","","",""],elements:["","弱","耐","","耐","","弱"],type:"回復"   }
        ]
    },*/
    {
        name:'地母神',
