...
var ddd_stable = [
    ...
    /*
    {
        ...
        devils:[
            {                name:'ガルーダ',         name_tw:'迦樓羅',       rarity:5,                grade:80, icon:'reityou_garuda.png', skills:["ザンダイン","ラクンダオート","バァーハナ"], skill4:["三段の賢魔","マハラギタイン","フォッグプレス","狂戦士","破魔無效"], skill5:["","マハマカジャマ","アムリタ","火炎ブースタ","アギラオ"], elements:["","反","弱","","無","耐",""], type:"攻擊"            },
            {                name:'ヤタガラス',         name_tw:'八咫烏',       rarity:4,                grade:66, icon:'reityou_yatagarasu.png', skills:["冥界破","スクンダオート","スピードスター"], skill4:["物理バースタ","モータルジハード","スクカジャ","寸分の見切り","物理耐性"], skill5:["","マハラギオン","一分の魔脈","ウインドプレス","緊縛耐性"], elements:["","無","弱","","","耐",""], type:"支援"            },
            {                name:'スザク',         name_tw:'朱雀',       rarity:3,                grade:53, icon:'reityou_suzaku.png', skills:["アギラオ","タルンダオート","メディラマ"], skill4:["ダークゾーン無効","マハンマ","バインドボイス","毒床渡り","物理耐性"], skill5:['','コロシの愉悅','クロズティ','メパララディ','ジオ'], elements:["弱","無","弱","","","",""], type:"回復"            },
            {                name:'ジャターユ',         name_tw:'佳塔由',       rarity:3,                grade:44, icon:'reityou_jatayu.png', skills:["スクカジャ","すくかオート","デカジャ"], skill4:["スクンダ","デスバウンド","リカーム","野獣の勘","電撃耐性"],skill5:["","マハザン","乱れ狂い","メポズムディ","カースディ"], elements:["","耐","","弱","吸","無","弱"], type:"支援"            },
...
var skill_stable = [
    {
        ...
        skills:[
            ...
            {"name":"乱・かすみ斬り","name_tw":"","desc":"敵に3～5回、物理属性の打撃型ダメージを威力50で与える","mp":6,"point":null,"element":"物理"},
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"精神漏出","name_tw":"精神漏出","desc":"敵全体に万能属性の魔法型ダメージを威力80で与え、MPを３失わせる。","mp":5,"point":6,"element":"万能"},
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"氷結ブースタ","name_tw":"高級火炎強化","desc":"氷結属性で与えるダメージが15％増加する。","mp":null,"point":6,"element":"パシップ"},
