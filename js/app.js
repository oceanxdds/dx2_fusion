...
const ddd_stable = [
    {
        ...
        devils:[
            ...
            //{   name:'マンセマット',        name_tw:'莫塞瑪特',      rarity:5,    grade:83, icon:'daitensi_mansemato.png', skills:["審判の光","バインドボイス","憎悪の試練"], skill4:["二分の魔脈","アイスエイジ","マカジャマオン","破魔ハイブースタ","氷結反射"], skill5:['','殺風激','乱れ狂い','ハマダイン','電撃耐性'], elements:["","弱","無","","反","反",""], type:"攻擊"     },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'ギリメカラ',    name_tw:'獨眼魔象',            rarity:4,                grade:67, icon:'jyasin_girimekara.png', skills:["呪殺耐性","反逆の魔象","メガトンプレス"], skill4:["バインドボイス","暴飲暴食","ラクンダ","ミナゴロシの愉悦","衝撃耐性"], skill5:["","審判の光","アギダイン","クロズディ","ブフーラ"],elements:["反","","","弱","弱","弱",""], type:'攻擊'            },
    ...
    },
    {
        ...
        devils:[
            ...
            { name:'ジャンヌ・ダルク', name_tw:'貞德', rarity:4, grade:78, icon:'eiyuu_jannu.png', skills:['回復ブースタ','天罰','オルレアンの祈り'], skill4:['勝利の息吹','ジャッジメント','静寂の祈り','魔封無効','火炎反射'], skill5:['','精神漏出','メディラマ','煉獄','ザンマ'], elements:['','弱','耐','耐','耐','',''], type:'回復'}
        ]
    },
    {
        name:'怪異',
